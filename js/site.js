...
(() => {
  ...
  const MARK = `<svg viewBox="0 0 120 88" aria-hidden="true"><circle cx="60" cy="44" r="34" fill="none" stroke="currentColor" stroke-width="1.4" opacity="0.85"/><circle cx="60" cy="44" r="27" fill="none" stroke="currentColor" stroke-width="0.7" opacity="0.55"/><circle cx="60" cy="44" r="20" fill="none" stroke="currentColor" stroke-width="0.55" opacity="0.35"/><circle cx="60" cy="44" r="13" fill="none" stroke="currentColor" stroke-width="0.45" opacity="0.25"/><path d="M48 30c-7 3-11 10-11 18 0 10 7 18 18 18 6 0 11-2 14-6" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round"/><path d="M66 58l8 10" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round"/><path d="M72 26v36M72 26h18M72 44h14" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 44h18c4 0 6-6 10-6 5 0 6 12 12 12 5 0 7-12 12-12 6 0 7 12 13 12 5 0 7-8 11-8h32" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M114 38c4 2 6 6 2 10-3 3-8 2-10-1 4 1 8-1 8-9z" fill="currentColor"/><circle cx="8" cy="44" r="2.2" fill="currentColor"/></svg>`;
